...
public class DrinkOrder {
    ...
    private int executionTime = -1; // to indicate it has not yet been initialised
    ...
    public int getExecutionTime() {
        /*
         * if it has not yet been initialized then return drink.getPreparationTime(),
         * otherwise it has either been calculated or set, so return the value of
         * executionTime
         */
        if (executionTime == -1) {
            executionTime = drink.getPreparationTime();
        }
